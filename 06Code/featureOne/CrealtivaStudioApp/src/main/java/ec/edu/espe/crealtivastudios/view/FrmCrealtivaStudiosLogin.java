...
if (txtUser.getText().isEmpty() || passPassword.getText().isEmpty()) {
    lblErrorMessage.setForeground(Color.red);
    lblErrorMessage.setText("Complete todos los campos");
    return;
}
...
private void txtUserKeyTyped(java.awt.event.KeyEvent evt) {                                    
    ...
    if (!Character.isLetter(c)) {
        ...
        lblErrorMessage.setForeground(Color.red);
        lblErrorMessage.setText("⚠ Solo se permiten letras");
    } else {
        lblErrorMessage.setText(""); // limpia el mensaje si es válido
    }
}
