...
public class CreativeStudioApp {
    ...
    public static void main(String[] args) {
        ...
        for (Bill b : Bill.getAllBills()) {
            // Asumo que este método existe en Bill.java para alertas de facturas
    ...
    private static void showFinancialSummary() {
        System.out.println("\n--- RESUMEN FINANCIERO ---");
        Object[] totalRevenue = Bill.getTotalRevenue();
        double totalPending = Bill.getTotalPending();

        System.out.println("Ingresos totales (Facturas pagadas): $" + String.format("%.2f", totalRevenue));
        System.out.println("Monto pendiente de cobro: $" + String.format("%.2f", totalPending));
        System.out.println("Total de facturas emitidas: " + Bill.getAllBills().size());
    }
